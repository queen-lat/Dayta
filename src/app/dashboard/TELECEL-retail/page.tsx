...
const dataBundles: DataBundle[] = [
  { id: "1", size: "1", price: 4, label: "1GB" },
  { id: "2", size: "2", price: 8, label: "2GB" },
  { id: "3", size: "3", price: 11, label: "3GB" },
  { id: "4", size: "5", price: 18, label: "5GB" },
  { id: "5", size: "10", price: 35, label: "10GB" },
  { id: "6", size: "20", price: 65, label: "20GB" },
  { id: "7", size: "50", price: 150, label: "50GB" },
];
      ...
      <main className="pt-32 pb-20 px-6 lg:px-8">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl mb-6 shadow-lg shadow-red-500/40">
              <Image
                src="/tele.png"
                width={60}
                height={60}
            ...
            <form onSubmit={handlePurchase} className="p-8">
              ...
              <div className="mb-6">
                ...
                <select
                  ...
                  required
                  className="w-full px-4 py-4 bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-2xl text-neutral-900 dark:text-white font-medium focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all appearance-none cursor-pointer"
                  style={{
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    pattern="[0-9]{10}"
                    required
                    className="w-full pl-12 pr-4 py-4 bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-2xl text-neutral-900 dark:text-white placeholder-neutral-400 font-medium focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all"
                  />
                </div>
                <p className="mt-2 text-xs text-neutral-500 dark:text-neutral-400">
                  Enter 10-digit Telecel number
                </p>
              </div>

              {/* Summary Card */}
              {selectedBundleData && (
                <div className="mb-6 p-6 bg-gradient-to-br from-red-50 to-red-100 dark:from-red-950/20 dark:to-red-950/20 rounded-2xl border border-red-200 dark:border-red-800/30">
              ...
              <button
                ...
                className="w-full py-4 px-6 rounded-2xl bg-gradient-to-r from-red-600 via-red-700 to-rose-700 text-white font-semibold text-base transition-all duration-300 hover:shadow-lg hover:shadow-red-500/50 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:shadow-none disabled:active:scale-100"
              >
                {isProcessing ? (
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-xs text-neutral-600 dark:text-neutral-400 leading-relaxed">
                  ...
                  <ul className="space-y-1 list-disc list-inside">
                    <li>
                      Telecel Bundle can take some time to activate, contact
                      support 24hours after payment with proof to request a
                      refund.
                    </li>
